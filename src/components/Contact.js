    ...
    return (
      <div>
        ...
        <div className="text-center text-sm pb-3 font-light">
          <p className="hover:text-blue-500">+34 650 534 828</p>
          <p className="hover:text-blue-500">epinczinger@gmail.com</p>
          <p className="hover:text-blue-500">Benalmadena, Spain</p>
        </div>
        <a target="_blank" rel="noreferrer" href="https://drive.google.com/u/0/uc?id=1oIsgqyZqXP4w52MmKGK3yDJTF2MIoAVk&export=download">
          Download CV
        </a>
      </div>
    );
